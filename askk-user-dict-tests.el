...
(ert-deftest askk-user-dict-tests-lookup ()
...
(ert-deftest askk-user-dict-tests-lookup-not-found ()
  (let (askk-user-dict--alist)
    (should-not (askk-user-dict-lookup "あい" nil))))

(ert-deftest askk-user-dict-tests-lookup-okurigana ()
  (let (askk-user-dict--alist)
...
(ert-deftest askk-user-dict-tests-add ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
    (should (equal askk-user-dict--alist '(("あい" (("愛")) nil))))))

(ert-deftest askk-user-dict-tests-add-okurigana ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あi" "い" '("合"))
    (should (equal askk-user-dict--alist
                   '(("あi" (("合")) (("い" ("合")))))))))

(ert-deftest askk-user-dict-tests-add-order ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
    (askk-user-dict--add-entry "あい" nil '("亜衣"))
...
(ert-deftest askk-user-dict-tests-add-order-okurigana ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あi" "い" '("合"))
...
(ert-deftest askk-user-dict-tests-add-multi ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
...
(ert-deftest askk-user-dict-tests-add-multi-okurigana ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あk" "か" '("開"))
    (askk-user-dict--add-entry "あk" "き" '("飽"))
...
(ert-deftest askk-user-dict-tests-delete-unknown-not-error ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
    (askk-user-dict--add-entry "あk" "き" '("飽"))
...
(ert-deftest askk-user-dict-tests-delete-all ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
    (askk-user-dict--add-entry "いえ" nil '("家"))
...
(ert-deftest askk-user-dict-tests-delete-sub ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あい" nil '("愛"))
    (askk-user-dict--add-entry "あい" nil '("亜衣"))
    (askk-user-dict--delete-entry "あい" nil '("愛"))
...
(ert-deftest askk-user-dict-tests-delete-all-sub-cands ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あk" "か" '("開"))
    (askk-user-dict--add-entry "あk" "き" '("飽"))
...
(ert-deftest askk-user-dict-tests-delete-part-sub-cands ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あk" "か" '("開"))
    (askk-user-dict--add-entry "あk" "き" '("飽"))
...
(ert-deftest askk-user-dict-tests-delete-preserve-cands ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あk" "か" '("開"))
    (askk-user-dict--add-entry "あk" "か" '("空"))
    (askk-user-dict--add-entry "あk" "き" '("空"))
...
(ert-deftest askk-user-dict-tests-delete-headword ()
  (let (askk-user-dict--alist)
    (askk-user-dict--add-entry "あk" "か" '("空"))
    (askk-user-dict--delete-entry "あk" "か" '("空"))
    (should-not (assoc "あk" askk-user-dict--alist))))

(ert-deftest askk-user-dict-tests-prefix-keys ()
